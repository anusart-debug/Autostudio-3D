...
/* v41.7: โลโก้ ChatGPT เดิมเป็นแค่เส้นสีเข้ม #111 ไม่มีพื้นหลัง — บนธีมมืด .dcard พื้นเข้มอยู่แล้ว
   เส้นสีเข้มจึงจมหายไปเลย ต่างจากโลโก้อื่นทุกตัวที่มีป้ายพื้นหลังสีตัวเองเป็นแผ่นทึบ (เหมือนไอคอน
   แอปมือถือ) ทำให้เห็นชัดคงที่ไม่ว่าอยู่บนพื้นธีมไหน — เพิ่มป้ายพื้นหลังดำ+เส้นขาวให้เหมือนกัน */
const LOGO_OPENAI='<svg viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5" fill="#0D0D0D"/><g fill="none" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 6c1.5 0 2.8 1 3.3 2.3 1.5.2 2.8 1.2 3.3 2.7.7 1.3.6 2.9-.4 4 .3 1.5-.2 3.1-1.5 4-.5 1.4-1.8 2.5-3.4 2.5-1.5 0-2.8-1-3.3-2.3-1.5-.2-2.8-1.2-3.3-2.7-.7-1.3-.6-2.9.4-4-.3-1.5.2-3.1 1.5-4 .5-1.4 1.8-2.5 3.4-2.5Z"/></g><circle cx="12" cy="12" r="2.1" fill="#fff"/></svg>';
